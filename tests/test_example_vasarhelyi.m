function out = test_example_vasarhelyi(SWARM_ALGORITHM, DRONE_TYPE)
% Moved the original example_vasarhelyi into a function and made minor
% syntax changes to match updates. This enables the original example to be
...
% Output states calculated by sim (moved out of below DEBUG block)
